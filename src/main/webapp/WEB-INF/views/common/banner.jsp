...
<%--
  메인 배너 슬라이더 (재사용 조각 파일)
  위치: /WEB-INF/views/common/banner.jsp

  사용 예)
    <jsp:include page="../common/banner.jsp">
      <jsp:param name="bannerId" value="mainBanner" />
    </jsp:include>

  필요 리소스: common.css → tagButton.css, banner.css, common.js
--%>
    ...
    <c:forEach var="row" items="${fn:split(testSlides, '|')}">
      ...
      <div class="banner-slide">
        ...
        <div class="banner-caption">
          ...
          <a class="banner-cta" href="${cp}${fn:trim(col[1])}">
            ${fn:trim(col[6])} <span aria-hidden="true">&rarr;</span>
          </a>
        </div>
      </div>
    </c:forEach>
