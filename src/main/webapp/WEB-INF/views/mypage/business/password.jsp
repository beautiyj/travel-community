...
<head>
    <jsp:include page="/WEB-INF/views/mypage/common/pageHead.jsp">
        <jsp:param name="title" value="사업자 비밀번호 변경"/>
    </jsp:include>
</head>
...
<main class="mypage-page">
    ...
    <div class="mypage-layout">
        ...
        <section class="mypage-content mypage-content--form" aria-labelledby="business-password-title">
        <div class="mypage-content__header"><h2 id="business-password-title">비밀번호 변경</h2></div>
        ...
        <form class="profile-edit__form mypage-form-card"
              action="${pageContext.request.contextPath}/mypage/business-info/password"
              method="post">
            ...
            <div class="input-field">
                ...
                <input id="newPassword" type="password" name="newPassword"
                       ...
                       placeholder="영문·숫자 포함 8~20자" required>
            </div>
            <div class="input-field">
                <label for="newPasswordCheck">새 비밀번호 확인</label>
                <input id="newPasswordCheck" type="password"
                       name="newPasswordCheck" autocomplete="new-password"
