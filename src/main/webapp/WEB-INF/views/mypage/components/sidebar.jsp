...
<aside class="mypage-sidebar" aria-label="마이페이지 메뉴">
    ...
    <nav class="mypage-sidebar__menu">
        ...
        <a class="mypage-sidebar__withdraw ${param.active eq 'withdraw' ? 'is-active' : ''}" href="${cp}/mypage/withdraw"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16M9 7V4h6v3m-9 0 1 13h10l1-13M10 11v5m4-5v5"/></svg>회원탈퇴</a>
