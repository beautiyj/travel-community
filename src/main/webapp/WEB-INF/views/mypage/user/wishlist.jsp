        ...
        <section class="mypage-content">
            ...
            <c:choose>
                <c:when test="${empty wishlist}">
                	<strong><div class="mypage-empty-state"><strong>아직 찜한 항목이 없습니다</strong><a href="${pageContext.request.contextPath}/">여행지 탐색하기</a></div>
                </c:when>
                <c:otherwise>
                    <div class="wishlist-grid">
                        <c:forEach var="wish" items="${wishlist}">
                            <a href="${pageContext.request.contextPath}/tour/detail?placeId=${wish.placeId}"
                               class="wishlist-item-link">
                                <article class="wishlist-item">
                                    ...
                                    <div class="wishlist-item__body">
                                        ...
                                        <p>
                                            찜한 날짜
                                            <c:out value="${fn:replace(wish.createdAt, 'T', ' ')}"
                                                   default="-" />
                                        </p>
                                    </div>
